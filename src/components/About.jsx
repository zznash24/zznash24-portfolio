...
const About = () => {
  return (
    <div className="-mt-[6rem]">
      ...
      >
        Hello, I'm Zach, a passionate Front-End Web Developer and UI/UX Designer
        with a strong foundation in creating exceptional user experiences. With
        ...
        SQL, and Sequelize, allowing me to build complete, end-to-end solutions.{" "}
      </motion.p>
